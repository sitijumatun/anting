 ...
 <aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Diri Saya
        <small>Silakan Perbaharui Foto Data Diri</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Foto Data Diri</a></li>
      </ol>
    </section>
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Foto Data Diri</h3>
            ...
            <div class="box-body" style="">
               <form role="form" class="center" method="post" action="controller/admin/datadiri_updategambar.php?kode=<?php echo $_SESSION['Id_Karyawan'];?>" enctype="multipart/form-data">
              <div class="box-body">
			  
				<center> <img class="img-circle" style="width:200px;height:200px" src="images/<?php echo $_SESSION['Foto']; ?>" alt="User Avatar">
				<div class="form-group" style="align:center">
				 <label for="exampleInputFile">Upload Foto</label></br>
                  <label for="exampleInputFile">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
				  <input style="border:20px" id="exampleInputFile" type="file" name="foto">
                  <p class="help-block">foto dapat berupa  .jpg / .png / .gif</p>
                </div>
				</center>
				<center>
				 
                <button class="btn bg-orange btn-flat margin"><i class="fa fa-fw  fa-recycle"></i>Perbaharui Foto Saya</button>
                </center>
              </div>
              <!-- /.box-body -->
