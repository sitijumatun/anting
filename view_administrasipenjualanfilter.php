...
$query = "SELECT sum(Total_Pemasukan) as jumlah FROM `apl_penjualan` WHERE YEAR(Tanggal_Penjualan)='$tahun' AND MONTH(Tanggal_Penjualan)='$angka'";
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
			 ...
			 <a href="pdffix/penjualanfilter.php?bulan=<?php echo $angka; ?>&tahun=<?php echo $tahun;?>"><button class="btn bg-blue btn-flat margin"><i class="fa fa-fw   fa-file-pdf-o"></i> Convert To Pdf</button></a>
