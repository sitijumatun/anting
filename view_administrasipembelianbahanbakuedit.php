...
$id = $_GET['kode'];
$query = "SELECT * FROM `apl_pembelian` WHERE Id_Pembelian='".$id."'";
	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
			  ...
			  <div class="box-body" style="">
               <form role="form" class="center" method="post" action="controller/admin/pembelianedit.php" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="nama barang" value="<?php echo $barang; ?>" name="barang" type="text">
				   
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Tanggal Pembelian</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="tanggal pembelian"  value="<?php echo $tanggal; ?>" name="tanggal" type="date">
                </div>
				 <div class="form-group">
                  <label for="exampleInputEmail1">Jumlah Barang</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="jumlah barang"  value="<?php echo $jumlah; ?>" name="jumlah" type="text">
				   <p class="help-block">Isikan dalam bentuk angka contoh 5</p>
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Harga Satuan</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="harga satuan"  value="<?php echo $harga; ?>" name="harga" type="text">
