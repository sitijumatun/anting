...
$query = "SELECT sum(Total_Gaji) as jumlah FROM `apl_penggajian` WHERE Status_Pengambilan=0";
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <a href="view_administrasipenggajiantambah.php"><button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-external-link"></i> Set Penggajian</button></a> <a href="view_administrasipenggajianambil.php"><button class="btn bg-red btn-flat margin"><i class="fa fa-fw fa-external-link"></i> Set Pengambilan</button></a>
             ...
             <h5 class="description-header">Rp. <?php echo $jumlah;  ?>,00</h5>
              <span class="description-text">JUMLAH (RP. ) Penggajian yang belum diambil</span>
             </div>
                  <!-- /.description-block -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php
					include "../apl_koneksi.php";
					$query="select apl_penggajian.kode_akun as kodeak, apl_penggajian.Id_Penggajian as kode, apl_karyawan.Nama as nama , apl_posisi.Posisi as posisi,apl_penggajian.Bonus as bonus, apl_penggajian.Total_Gaji as total,apl_penggajian.Bulan as bulan,apl_penggajian.Tahun as tahun, apl_penggajian.Status_Pengambilan as status FROM apl_penggajian, apl_karyawan, apl_posisi WHERE apl_penggajian.Id_Karyawan = apl_karyawan.Id_Karyawan AND apl_karyawan.Id_Posisi = apl_posisi.Id_Posisi AND apl_penggajian.Status_Pengambilan=0 ";
					$sql = mysqli_query($conn,$query);
					while($data = mysqli_fetch_array($sql)){
							echo "<tr>";
					...
					?>
							<td><?php echo"<center>
								<a href='controller/admin/penggajianambil.php?kode=".$data['kode']."'><i class='fa fa-fw fa-check-square-o'></i>Tandai diambil</a></center>"; ?></td>
							<?php echo "</tr>";
					}
					?>
