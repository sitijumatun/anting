	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
			  ...
			  <div class="box-body" style="">
               <form role="form" class="center" method="post" action="controller/admin/masterdatakaryawantambah.php" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="usia" name="usia" type="text">
                </div>
				<div class="form-group">
                  <label for="exampleInputEmail1">Hp</label>
                  <input class="form-control" id="exampleInputEmail1" placeholder="hp" name="hp" type="text">
                </div>
				 <div class="form-group">
