...
$query = "SELECT sum(Total_Gaji) as jumlah FROM `apl_penggajian` WHERE Status_Pengambilan=1 AND Bulan='$bulan' AND Tahun='$tahun'";
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <?php
					include "../apl_koneksi.php";
					$query="select apl_penggajian.kode_akun as kodeak, apl_penggajian.Id_Penggajian as kode, apl_karyawan.Nama as nama , apl_posisi.Posisi as posisi,apl_penggajian.Bonus as bonus, apl_penggajian.Total_Gaji as total,apl_penggajian.Bulan as bulan,apl_penggajian.Tahun as tahun, apl_penggajian.Status_Pengambilan as status FROM apl_penggajian, apl_karyawan, apl_posisi WHERE apl_penggajian.Id_Karyawan = apl_karyawan.Id_Karyawan AND apl_karyawan.Id_Posisi = apl_posisi.Id_Posisi AND Bulan='$bulan' AND Tahun='$tahun' ";
					$sql = mysqli_query($conn,$query);
					while($data = mysqli_fetch_array($sql)){
							echo "<tr>";
