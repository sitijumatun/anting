	 ...
	 <section class="content">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="box-body" style="">
			  ...
			  <div class="box-body" style="">
               <form role="form" class="center" method="post" action="controller/admin/penggajiantambah.php" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <select class="form-control" name="nama">
                    <?php
							...
							$query2="select * from apl_karyawan";
				 ...
				 <div class="form-group">
                  ...
                  <input class="form-control" id="exampleInputEmail1" placeholder="bonus" name="bonus" type="text">
				   <p class="help-block">Isikan dalam bentuk angka misal 5000</p>
                </div>
				
				<center>
                <button class="btn bg-orange btn-flat margin"><i class="fa fa-fw fa-external-link"></i>  Tambah data penggajian</button>
                </center>
              </div>
              <!-- /.box-body -->
